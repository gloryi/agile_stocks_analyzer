...
############# ### ### ### ### ### ### ### ###
    ...
    def run(self):
        evaluated = {"target" : [self.variant_candles], "variant_candles":[self.variant_candles], "variant_indicators":[]}
...
class EVALUATOR():
    ...
    def evaluate(self, O,C,H,L,V):
            ...
            if isFirst:
               ...
               self.image_path = self.generate_image(evaluated["target"] +evaluated["variant_candles"],evaluated["variant_indicators"],MA_LAG//2 ,lastCandle.index ,directory = f"dataset{timeframe}")
               return "INIT"
